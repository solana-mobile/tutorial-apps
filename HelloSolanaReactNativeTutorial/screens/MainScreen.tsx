...
import AccountInfo from '../components/AccountInfoSection';
  ...
  return (
    <>
        <View style={styles.mainContainer}>
          ...
          <ConnectWalletButton onWalletConnect={async (authorization: Authorization) => { setAuthorization(authorization) }} />
        </View>
    </>
  );
}
